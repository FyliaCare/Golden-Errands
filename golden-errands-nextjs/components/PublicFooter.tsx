...
export default function PublicFooter() {
  return (
    <>
      ...
      <footer style={{ background: '#1a1a1a', color: 'white', paddingTop: 40 }}>
        <div className="footer-container">
          <Row gutter={[24, 24]}>
            {/* Company Info */}
            <Col xs={24} sm={12} lg={6}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                <RocketOutlined style={{ fontSize: 28, color: '#E63946' }} />
                <div>
                  <div style={{ fontSize: 16, fontWeight: 'bold', color: '#E63946', lineHeight: 1.2 }}>
                    GOLDEN ERRANDS
                  </div>
            ...
            <Col xs={24} sm={12} lg={6}>
              ...
              <Space direction="vertical" size="small" style={{ width: '100%' }}>
                <Space size="small">
                  ...
                  <Text style={{ color: '#999', fontSize: 13 }}>0256039212</Text>
                </Space>
                <Space size="small">
                  <PhoneOutlined style={{ color: '#E63946', fontSize: 16 }} />
                  <Text style={{ color: '#999', fontSize: 13 }}>0256039213</Text>
                </Space>
                <Space size="small">
                  <MailOutlined style={{ color: '#E63946', fontSize: 16 }} />
                  <Text style={{ color: '#999', fontSize: 13 }}>info@goldenerrands.com</Text>
                </Space>
                <Space size="small" align="start">
                  <EnvironmentOutlined style={{ color: '#E63946', fontSize: 16 }} />
                  <Text style={{ color: '#999', fontSize: 13 }}>Accra, Ghana</Text>
                </Space>
              </Space>
            </Col>
          </Row>
          ...
          {/* Newsletter */}
          <Row className="newsletter-section" style={{ borderTop: '1px solid #333' }} gutter={[16, 16]}>
            <Col xs={24} md={12}>
              <Title level={4} style={{ color: '#FFB703', marginBottom: 8, fontSize: 16 }}>
                Subscribe to Newsletter
              </Title>
              <Text style={{ color: '#999', fontSize: 13 }}>Get updates on special offers</Text>
            </Col>
            <Col xs={24} md={12}>
