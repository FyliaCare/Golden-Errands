      ...
      <section style={{ padding: '60px 20px', background: 'white' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <Paragraph>
              By using Golden Errands delivery services, you agree to be bound by these Terms and Conditions. 
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <Paragraph>
              Golden Errands provides delivery and errand services including but not limited to food delivery, 
          ...
          <div style={{ marginBottom: 48 }}>
            ...
            <Paragraph>
              - Golden Errands is not liable for damages resulting from improper packaging
            </Paragraph>
            <Paragraph>
