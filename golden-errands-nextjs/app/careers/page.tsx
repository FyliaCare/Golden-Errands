          ...
          <Row gutter={[32, 32]}>
            <Col xs={24} md={8}>
              ...
              <Paragraph style={{ color: '#666' }}>
                Send your CV and cover letter to careers@goldenerrands.com
              </Paragraph>
            </Col>
            <Col xs={24} md={8}>
              <div
      ...
      <section style={{ padding: '80px 20px', background: 'white', textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <Paragraph style={{ fontSize: 18, color: '#666', marginBottom: 32 }}>
            Take the first step towards an exciting career with Golden Errands
          </Paragraph>
          <Space size="large">
            <a href="mailto:careers@goldenerrands.com">
