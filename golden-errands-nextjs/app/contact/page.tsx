...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <MailOutlined />,
      title: 'Email',
      details: ['info@goldenerrands.com', 'support@goldenerrands.com'],
      color: '#FFB703',
    },
    {
      icon: <EnvironmentOutlined />,
      title: 'Address',
      details: ['Accra, Ghana', 'Delivery coverage across Greater Accra'],
      color: '#06d6a0',
    },
    {
      ...
      <section style={{ padding: '60px 20px', background: '#1a1a1a', textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <Space size="large" wrap>
            ...
            <a href="mailto:info@goldenerrands.com">
