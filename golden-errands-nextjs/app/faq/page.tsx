...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      children: (
        <p>
          We currently cover the entire Greater Accra region, including Accra, Tema, Kasoa, and surrounding areas. 
    ...
    {
      key: '12',
      label: 'How do I become a rider with Golden Errands?',
      children: (
        <p>
    ...
    },
    {
      ...
      children: (
        <p>
          We value your feedback! Contact us at info@goldenerrands.com, call 0256039212, or use the contact form on our 
